  ...
  <body class="subpage">
    ...
    * * * * *  
    ...
    +-------------------------- min (0 - 59)
                    ...
                    A <span style="font-weight:bold">*</span> stands for "any", so, for instance, if we want to execute a script every 5 minutes, we will enter the following expression:
                    <br />
                ...
                <div align="center">
                    <a title="Scheduler Event" href="images/hg_scheduler_01.jpg" rel="gallery" class="pirobox_gall"><img src="images/hg_scheduler_01.jpg" alt="" width="300"></a>                    <a title="Scheduler condition trigger in Wizard Scripts" href="images/hg_scheduler_02.jpg" rel="gallery" class="pirobox_gall"><img src="images/hg_scheduler_02.jpg" alt="" width="300"></a>                </div>
                <p>In the pictures above, we can see some example events defined in the Scheduler and a Wizard Script using them.</p>
                <div align="center">
                    <a title="An example automation program plugin using the Scheduler Helper class" href="images/hg_scheduler_03.jpg" rel="gallery" class="pirobox_gall"><img src="images/hg_scheduler_03.jpg" alt="" width="300"></a>                </div>
                <p>In the example above we can see how the Scheduler can be used by program plugins (Scheduled ON/OFF).</p>
                <p>Also note that "Sunrise" and "Sunet" events in the scheduler are automatically updated by the Weather Underground automation program when enabled.</p>
                <p>As shown in these examples, we can also describe an event by using more than one expression, separating them with a colon ':', that will basically stand for OR operator, and by using a semi-colon ';', that will behave like the AND operator (HG > r341 required for this to work).</p>
                <div class="row">
                  <div class="4u" align="left"><a href="/docs/interconnecting.php">&lt;&lt; Interconnections</a></div>
                  <div class="4u" align="center"><a href="/docs/scheduler.php#">TOP</a></div>
                  <div class="4u" align="right"><a href="/docs_api/index.html">Automation Programming &gt;&gt;</a></div>
                </div>
              </section>
            </div>
            <div class="3u">
