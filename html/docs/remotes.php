                    ...
                    <div class="row">
                        <div class="9u skel-cell-important">
                            ...
                            <section>
                                ...
                                <p>
                                    It's true, today many people own a mobile device such as smartphones and tablets. But what we will really find in almost every house is the old good <a href="http://en.wikipedia.org/wiki/Remote_control" target="_blank">infrared remote control</a>.
                                    <br />
                                ...
                                <div align="center"><img title="Configuring LIRC" alt="Configuring LIRC" src="/docs/images/hg_remotes_01.jpg" width="70%">
                                </div>
                                <br />
                                <p>
                                    As shown in the picture above, we can setup the IR remote control in HomeGenie from the <span style="font-weight:bold">Configure->Settings</span> section by
                                    enabling the <span style="font-weight:bold">LIRC Infrared Remotes</span> interface and by adding our remote model to the configuration.
                                    <br />
                                    Once configured, HomeGenie will be able to receive events from the IR remote. So, now, we can create automation scripts triggered by remote control buttons,
                                    simply by adding a new Wizard Script and by capturing the code of the desired IR button as shown in the example below.
                                </p>
                                <div align="center"><img title="Triggering a script from IR command" alt="Triggering a script from IR command" src="/docs/images/hg_remotes_02.jpg" width="70%">
                                </div>
                                <br />
                                <p>
