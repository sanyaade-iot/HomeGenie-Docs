            ...
            <div class="6u skel-cell-important">
              ...
              <section>
                ...
                <ul style="list-style-type:square;margin-left:10px">
                  ...
                  <li>
                    <h3>Integrated drivers for X10, Z-Wave, Philips Hue and UPnP</h3>
                  ...
                  <li>
                    ...
                    <strong>IoT ready!</strong> With web based <i>Program Editor</i> and compiler supporting
                    Javascript, Ruby, Python and C# language
                  </li>
                  <li>
                  ...
                  <li>
                    <h3>Direct access to <a title="What is Raspberry Pi? (click for video)" href="http://www.youtube.com/embed/e0wkVVVLvR8?autoplay=1" rel="iframe-800-520" class="pirobox_gall1">
                        <img src="/docs/images/playvideo.png" />&nbsp;Raspberry&nbsp;Pi
                    </a> hardware</h3>
