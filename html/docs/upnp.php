          ...
          <div class="row">
            <div class="9u skel-cell-important">
              ...
              <section>
                ...
                <p>
                    Thanks to 
                    <a rel="iframe-800-520" class="pirobox_gall1" title="What is DLNA? (click for video)" href="http://www.youtube.com/embed/ygilmTwLSJ0?autoplay=1">
                      <img src="/docs/images/playvideo.png" /> UPnP/DLNA
                    </a>
                    integration, HomeGenie can also act as a Media Control Point to script and control your media devices and UPnP lighting.
                    <br />
                    Sharing your media from room to room and device to device has never been easier. From <span style="font-weight:bold">Configure->Groups and Modules</span> section we can add to the control page our media devices
                ...
                <p>
                   Then we will be able to browse our Media Servers from the control page (either from the web interface or the mobile client) and send pictures, videos and music to any Media Receiver.
                </p>

                <div align="center"><img title="Restarting APP" alt="Restarting APP" src="/docs/images/hg_upnp_03.jpg" width="70%"></div>
                ...
                <div align="center">
                    <a title="Media renderer controls" href="images/hg_upnp_04.jpg" rel="gallery" class="pirobox_gall"><img alt="Media renderer controls" src="/docs/images/hg_upnp_04.jpg" width="28%"></a>
                    <a title="UPnP within Android APP" href="images/hg_upnp_05.jpg" rel="gallery" class="pirobox_gall"><img alt="UPnP within Android APP" src="/docs/images/hg_upnp_05.jpg" width="35%"></a>
                </div>
          
                <p>For a list of DLNA/UPnp Media Servers and Clients see <a href="http://en.wikipedia.org/wiki/List_of_UPnP_AV_media_servers_and_clients" target="_blank">Wikipedia</a> </p>

                <div class="row">
                  <div class="4u" align="left"><a href="/docs/weather.php">&lt;&lt; Weather Service</a></div>
                  <div class="4u" align="center"><a href="/docs/upnp.php#">TOP</a></div>
                  <div class="4u" align="right"><a href="/docs/remotes.php">InfraRed and RF remotes &gt;&gt;</a></div>
                </div>
              </section>
            </div>
            <div class="3u">
