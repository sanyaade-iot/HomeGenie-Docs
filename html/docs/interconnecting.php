                    ...
                    <div class="row">
                        <div class="9u skel-cell-important">
                            ...
                            <section>
                                ...
                                <div align="center"><img title="Configuring LIRC" alt="Configuring LIRC" src="/docs/images/hg_interconn_01.jpg" width="70%">
                                </div>
                                <br />
                                ...
                                <p>
                                    ...
                                    <br />
                                    <span style="font-weight:bold">The devices available from the source HG node will be visible on the target HG node once that an event is generated from the source HG node</span> (eg. turn a device on/off).
                                    <br />
                                ...
                                <p>
                                    ...
                                    <ul style="list-style-type:square;padding-left:30px;">
                                        ...
                                        <li>
                                            Design our home automation network as centralized or make it behave like a <a href="http://en.wikipedia.org/wiki/Grid_network" target="_blank">grid network</a>, or a mix of both
                                        </li>
                                    </ul>
                                </p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="4u" align="center">
                                        <a href="/docs/interconnecting.php#">TOP</a>
                                    </div>
                                    <div class="4u" align="right">
                                        <a href="/docs/scheduler.php">Events scheduler &gt;&gt;</a>
                                    </div>
                                </div>
                            </section>
                        </div>
