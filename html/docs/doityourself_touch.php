...
<html>
  <head>
    ...
    <title>HomeGenie, Home Automation Touch Panel</title>
            ...
            <div class="9u skel-cell-important">
              ...
              <section>
                ...
                <p>
                    ...
                    </a>, like we already did in the <a href="doityourself.php">DIY Home Automation Server</a> project, we're now going to build a TFT Touch Panel for our Home Automation system based on HomeGenie.
                </p>
...
<br />
                ...
                <h3>About the HomeGenie Touch Panel software</h3>
                <p>
                The software you see in these screenshot (HomeGenie Smart Control) is still under development and it will be completed by the end of June 2014. <br />
                It is currently built for running on any 320x240 Touchscreen Display. <br />
                The final relase will come on a prebuilt SD-Card image with pre-configured drivers for Adafruit TFT Touchscreen and automatic startup of HG Smart Control, so the only thing needed
                to make it run it will be writing the SD-Card image.
                <br />
                ...
                <div align="center">
                  <a href="/docs/doityourself_touch.php#">TOP</a>
                </div>
              </section>
            </div>
            <div class="3u">
