            ...
            <div class="12u">
              ...
              <section>
                ...
                <p style="float:left;text-wrap:no-wrap;margin-left:50px">
                    ...
                    <a target="_top" title="Download HomeGenie for Windows" href="http://sourceforge.net/projects/homegenie/files/HomeGenie_1_00_beta_r394.exe/download">
                        <strong style="text-decoration: underline;">HomeGenie 1.00 beta rev. 394</strong>
                    </a><br>
                ...
                <p style="float:left;text-wrap:no-wrap;margin-left:50px">
                    ...
                    <a title="HomeGenie for Debian Linux" href="http://sourceforge.net/projects/homegenie/files/homegenie-beta_1.00.r415_all.deb/download">
                        <strong style="text-decoration: underline;">HomeGenie 1.00 beta rev. 415</strong>
                    </a><br>
                ...
                <p style="float:left;text-wrap:no-wrap;margin-left:50px">
                    ...
                    <a title="Download HomeGenie platform agnostic archive" href="http://sourceforge.net/projects/homegenie/files/homegenie_1_00_beta_r415.tgz/download">
                        <strong style="text-decoration: underline;">HomeGenie 1.00 beta rev. 415</strong>
                    </a><br>
                ...
                <p style="float:left;text-wrap:no-wrap;margin-left:50px;margin-left:50px">
                    <img src="images/logos/bpilogo.jpg" alt="" style="margin-right:16px" align="left" width="96">
                    <a title="Download HomeGenie for Banana Pi (prebuilt SD-Card)" href="http://sourceforge.net/projects/homegenie/files/HomeGenie_1_00_beta_r411_banpi-armhf-4GB.zip/download">
                        <strong style="text-decoration: underline;">HomeGenie 1.00 beta rev. 411</strong>
                    </a><br>
                    Banana Pi SD-Card<br>
                    Raspbian w/ Mono 3.2
                </p>
                <p style="float:left;text-wrap:no-wrap;margin-left:50px;margin-left:50px">
                    <img src="images/logos/rpiicon.png" alt="" style="margin-right:16px" align="left" width="96">
                    <a title="Download HomeGenie for Raspberry Pi (prebuilt SD-Card)" href="http://sourceforge.net/projects/homegenie/files/HomeGenie_1_00_beta_r403_raspi-armhf-4GB.zip/download">
                        <strong style="text-decoration: underline;">HomeGenie 1.00 beta rev. 403</strong>
                    </a><br>
                    Raspberry Pi SD-Card<br>
                    Raspbian w/ Mono 3.2
                </p>
                <p style="float:left;text-wrap:no-wrap;margin-left:50px;">
                    ...
                    <a title="HomeGenie client for Android" href="https://play.google.com/store/apps/details?id=com.glabs.homegenie">
                        <strong style="text-decoration: underline;">HomeGenie for Android</strong>
                    </a><br>
                    Play Store<br>
                    Android 2.2 and up
                </p>
                <p style="float:left;text-wrap:no-wrap;margin-left:50px;">
                    ...
                    <a title="HomeGenie client for Windows Phone" href="http://www.windowsphone.com/en-us/store/app/homegenie/b3bff0d6-f65a-4ce5-93f7-7be68d4849f3">
                        <strong style="text-decoration: underline;">HomeGenie for Windows Phone</strong>
                    </a><br>
                    Windows Store<br>
                    WP 7.5 and up
                </p>
			...
			Latest <em>testing</em> build
                ...
                <p> Download Debian Package file and install it by double
                  ...
                  <span style="font-family: courier;">
                    ...
                    &nbsp;&nbsp; sudo gdebi homegenie-beta_1.00.403_all.deb</span><br>
...
########################################################</pre>
                ...
                <ul style="margin: 1em 0px 1em 5px; padding: 0px 0px 0px 15px; list-style-type: none; border-left-width: 5px; border-left-style: solid; border-left-color: gray; color: rgb(34, 34, 34);">
                  <li><b style="font-weight: bold;">tar xzvf&nbsp;</b><span class="Apple-converted-space"></span>HomeGenie_1_00_beta_r403.tgz</li>
                </ul>
